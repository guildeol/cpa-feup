...
int main(int argc, char** argv) {
    ...
    for (int k = 0; k < size; ++k) {
        ...
        MPI_Bcast(submatrix_A, submatrix_size * matrix_size, MPI_INT, k / submatrix_size, MPI_COMM_WORLD);
        ...
        MPI_Sendrecv_replace(submatrix_B, matrix_size * submatrix_size, MPI_INT, destination, 0, source, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
    }
